...
enum Config {
    static let EXPO_PUBLIC_FEATHERLESS_API_KEY = ""
    static let EXPO_PUBLIC_FEATHERLESS_MODEL = ""
    static let EXPO_PUBLIC_RORK_TOOLKIT_SECRET_KEY = ""
    static let EXPO_PUBLIC_TOOLKIT_URL = ""

    static let allValues: [String: String] = [
        "EXPO_PUBLIC_FEATHERLESS_API_KEY": EXPO_PUBLIC_FEATHERLESS_API_KEY,
        "EXPO_PUBLIC_FEATHERLESS_MODEL": EXPO_PUBLIC_FEATHERLESS_MODEL,
